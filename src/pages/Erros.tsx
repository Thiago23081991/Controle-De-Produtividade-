...
const ErrosContent: React.FC = () => {
    ...
    const { loadErros, isLoading, erros, period, setPeriod } = useErros();
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-top-10 duration-700 pb-24">
            ...
            {/* Banner Hero */}
            <div className="bg-gradient-to-br from-slate-900 to-red-950 rounded-[3rem] shadow-2xl p-8 md:p-12 border-4 border-red-600 relative overflow-hidden flex flex-col gap-6">
            ...
            <button
                onClick={() => setIsModalOpen(true)}
                className="fixed bottom-8 right-8 z-40 bg-red-600 hover:bg-red-500 text-white px-6 py-4 rounded-[2rem] font-black uppercase tracking-widest text-xs flex items-center gap-3 shadow-2xl shadow-red-900/50 active:scale-95 transition-all group animate-in fade-in slide-in-from-bottom-4 duration-500"
